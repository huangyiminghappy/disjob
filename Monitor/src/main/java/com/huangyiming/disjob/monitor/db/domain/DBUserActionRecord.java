...
public class DBUserActionRecord {
	...
	public DBUserActionRecord(){
		
	}
	
	public DBUserActionRecord(String username, String permitItem, String param) {
		this.username = username;
		this.permitItem = permitItem;
		this.actionParam = param;
	}
	
	public DBUserActionRecord(String username, String permitItem) {
		this.username = username;
		this.permitItem = permitItem;
	}
