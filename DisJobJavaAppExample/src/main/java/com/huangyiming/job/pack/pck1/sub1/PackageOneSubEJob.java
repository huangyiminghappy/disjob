package com.huangyiming.job.pack.pck1.sub1;
...
@JobDec(group="packagesOne",jobName="packageOneSubEJob",quartz="0/40 * * * * ?",fireNow=true)
public class PackageOneSubEJob implements DisJob{
