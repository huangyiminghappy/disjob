...
package com.huangyiming.disjob.common.log;
...
public class DefaultLogService implements LogService {
    ...
    private static Logger disJobStats = LoggerFactory.getLogger("disJobStats");
    private static Logger profileLogger = LoggerFactory.getLogger("profile");
    private static LocalHost local = new LocalHost();
    
    static{
    	MDC.put("ip", local.getIp());
    }
    ...
    public boolean isStatsEnabled() {
        return disJobStats.isInfoEnabled();
    }
}
