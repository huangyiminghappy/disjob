...
function updateIframeInfo(url,title){
	//return false;
	var domain = window.location.protocol+"//"+window.location.host;
	url = url.replace(domain, "");
	$(".J_menuTab.active").attr("data-id",url);
	
	$(".J_menuTab.active").html(title + '<i class="fa fa-times-circle"></i>');
