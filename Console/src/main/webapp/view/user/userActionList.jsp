...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="table-responsive">
							<table id="userActionList" class="table table-hover table-bordered results"></table>
						</div>
					</div>
				</div>
			</div>
    ...
    <script type="text/javascript" src="<%=path %>/resources/user/userActionList.js"></script>
</body>
</html>
