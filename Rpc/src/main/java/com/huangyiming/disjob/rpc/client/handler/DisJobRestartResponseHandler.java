...
public class DisJobRestartResponseHandler extends SimpleChannelInboundHandler<DisJobResponse> {

	private final boolean autoRelease;
	public PhpTaskCmd cmd;
	
 	public DisJobRestartTaskResponse response;
  
 	public CountDownLatch downLatch;
	public DisJobRestartResponseHandler(PhpTaskCmd cmd,DisJobRestartTaskResponse response,CountDownLatch downLatch ) {
 		autoRelease = true;
 		this.cmd = cmd;
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		...
		try {
			if (acceptInboundMessage(msg)) {
				DisJobRestartTaskResponse msgResp = (DisJobRestartTaskResponse)msg;
