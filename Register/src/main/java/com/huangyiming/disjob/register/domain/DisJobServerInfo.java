 ...
 * <pre>
 * 
 *  File: SlaveServer.java
 * 
 *  Copyright (c) 2016, huangyiming.com All Rights Reserved.
 * 
 *  Description:
 *  EJOBserver根据ip权重进行负载均衡的类
 * 
 *  Revision History
 *  Date,					Who,					What;
 ...
 * </pre>
 */
public class DisJobServerInfo implements Serializable,Comparable<DisJobServerInfo>{
    ...
    public DisJobServerInfo(String ip) {
        this.ip = ip;
    }
    
    public DisJobServerInfo(String ip, int weight) {
        super();
        this.ip = ip;
        this.weight = weight;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        DisJobServerInfo other = (DisJobServerInfo) obj;
        if (ip == null)
        {
            if (other.ip != null)
                return false;
	...
	@Override
	public int compareTo(DisJobServerInfo o) {
