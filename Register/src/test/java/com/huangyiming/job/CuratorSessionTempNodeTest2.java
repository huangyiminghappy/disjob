...
public class CuratorSessionTempNodeTest2 {
...
//	static final String zkhost = "10.40.6.100:2181,10.40.6.101:2181,10.40.6.102:2181";
	public static void main(String[] args){
		...
		String root = "disJob";
		try {
			if(client.checkExists().forPath("/" + root + "/session/100") == null){
				client.create().creatingParentsIfNeeded().forPath("/" + root + "/session/100");
			}
			client.create().withMode(CreateMode.EPHEMERAL).forPath("/" + root + "/session/100/10.40.6.100:9501");
